...
class ListadoMaterialesController extends BaseController
{
	public function index(){
		// Primero obtendremos el array de los datos
		$Datos = ListadoMaterial::all();
    ...
    public function store(Request $request){
        ...
        $Datos = array("idListadoActividad"=>$request->input("idListadoActividad"),
        ...
        if(!empty($Datos)){
            ...
            $validacion = Validator::make($Datos,[
                                          "idListadoActividad" => 'required|integer',
                                          "idProducto" => 'required|integer',
                                          "CantidadProducto" => 'required|float']);
